    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <p><strong> Case reference:</strong> {crmCaseReference} 12345_CHANGE_ME</p>
                { receiptNumber ?
                    <Fragment>
                        <p><strong>Receipt number:</strong> {receiptNumber} 12345_CHANGE_ME_TOO</p> <p>Thanks for your payment, your request has been approved. You&apos;ll receive a confirmation email</p>
